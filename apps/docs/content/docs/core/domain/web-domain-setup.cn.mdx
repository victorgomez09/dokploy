---
title: "Web 域名设置"
description: "学习如何为 Alvi Paas 面板设置主域名"
---

## 介绍

本指南涵盖 Alvi Paas 面板主域名的基本设置。
...
4. 保存记录。 您的 DNS 记录将是 `web.alvi-paas.com`.

## Alvi Paas 面板设置

1. 登录您的 Alvi Paas 面板。
2. 导航到 `/dashboard/settings/server`.
3. 在服务器域下，将您的域设置为与 Cloudflare 中配置的域相匹配(例如, `web.alvi-paas.com`).
4. 保存，应用更改需要约 20 秒的时间生效。
5. 通过以下方式访问您的面板 `https://web.alvi-paas.com`.

<ImageZoom
  src="web-domain-setup/alvi-paas-domain.png"
  width={800}
  height={630}
  quality={100}
  priority
