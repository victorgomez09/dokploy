---
title: "Requirements"
description: "See a requirements for a domain for the Alvi Paas panel"
---

This guide will give you an idea of the requirements to assign a domain to your Alvi Paas panel or use it in any other application, whether Docker Compose or otherwise.
