...
Alvi Paas offers several deployment methods, streamlining the process whether you're utilizing GitHub, any Git provider, Raw, or automated deployments.
...
2. When creating an application, Alvi Paas automatically retrieves the available repositories and branches.
...
<ImageZoom
  src="/assets/alvi-paas-ssh-compose.png"
  width={800}
  height={630}
