---
title: Auto-deploy
description: How to auto-deploy your docker-compose application with Alvi Paas
---

Automatically deploying your docker-compose application to Alvi Paas can be achieved through two primary methods: using Webhooks or the Alvi Paas API. Each method supports various platforms and provides a streamlined deployment process.
...
```http
curl -X 'POST' \
  'https://canary.alvi-paas.com/api/compose.deploy' \
  -H 'accept: application/json' \
