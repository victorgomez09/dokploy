...
This section outlines how to configure domains for your applications in Alvi Paas, ensuring that your applications are accessible via custom URLs.

### Add Domain

Associate custom domains with your application to make it accessible over the internet.

- **Host**: The domain name that you want to link to your application (e.g., `api.alvi-paas.com`).
...
- **Certificate**: Select whether to secure the domain with SSL/TLS certificates. Alvi Paas supports automatic provisioning of SSL certificates via Let's Encrypt.
