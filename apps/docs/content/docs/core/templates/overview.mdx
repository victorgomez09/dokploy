---
title: Templates
description: Deploy open source templates with Alvi Paas
---
...
We accept contributions to upload new templates to the alvi-paas repository.

Make sure to follow the guidelines for creating a template:

[Steps to create your own template](https://github.com/Alvi Paas/alvi-paas/blob/canary/CONTRIBUTING.md#templates)
