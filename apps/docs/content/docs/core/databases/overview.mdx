---
title: Overview
description: "Discover how to create and backup databases easily with Alvi Paas, supporting a variety of database systems."
---

Alvi Paas simplifies the process of creating and managing databases, offering robust options for both setup and backups.

## Database Support

Alvi Paas currently supports a range of popular database systems, ensuring compatibility and flexibility for your projects:
