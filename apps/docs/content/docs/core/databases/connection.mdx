---
title: Connection
description: "Learn how to connect to your database using Alvi Paas."
---

This section explains how to configure database access for applications in Alvi Paas, including both internal connections within your network and external connections accessible over the internet.
